...
# Script to download Scene-N1 dataset from Hugging Face
# Usage: ./download_scene_n1.sh <target_folder> [branch]
# Example: ./download_scene_n1.sh /path/to/data main
...
if [ $# -lt 1 ]; then
    ...
    echo "  branch: Dataset branch (default: main)"
    echo ""
    echo "Examples:"
    echo "  $0 /data/scene_n1           # Download to /data/scene_n1 (main branch)"
    echo "  $0 /data/scene_n1 main      # Download main branch explicitly"
    exit 1
fi
...
echo "=========================================="
echo "Scene-N1 Dataset Download Script"
echo "=========================================="
...
echo "1. Visit: https://huggingface.co/datasets/InternRobotics/Scene-N1"
...
# Clone the dataset
REPO_URL="https://huggingface.co/datasets/InternRobotics/Scene-N1"

if [ -n "$HF_TOKEN" ]; then
    # Use token for authentication
    AUTH_URL="https://${HF_TOKEN}@huggingface.co/datasets/InternRobotics/Scene-N1"
...
echo "Or use selective download commands for specific components:"
echo "  git lfs pull --include=\"scene_data/mp3d_pe/**\""
echo "  git lfs pull --include=\"scene_data/mp3d_n1/**\""
echo "  git lfs pull --include=\"scene_data/mp3d_ce/**\""
echo "  git lfs pull --include=\"scene_data/n1_eval_scenes/**\""
